...
window.addEventListener("load",function(){
  ...
  //document.getElementById("Resultado_Calculos").hidden = true;
...
// Capacidad Conductor 
MCMlista.addEventListener("click",function(){

  var MCMlista = document.getElementById("MCMlista").checked;

    if (MCMlista == true){

      document.getElementById("AWGlista")  .checked = false;
      document.getElementById("CalibreMCM").disabled = false;
      document.getElementById("CalibreAWG").disabled = true;
      
    } else {

      document.getElementById("AWGlista")  .checked = true;
      document.getElementById("CalibreMCM").disabled = true;
...
AWGlista.addEventListener("click",function(){

  var AWGlista = document.getElementById("AWGlista").checked;
  
    if (AWGlista == true){

      document.getElementById("MCMlista")  .checked = false;
      document.getElementById("CalibreMCM").disabled = true;
      document.getElementById("CalibreAWG").disabled = false;
      
    } else {

      document.getElementById("MCMlista")  .checked = true;
      document.getElementById("CalibreMCM").disabled = false;
      document.getElementById("CalibreAWG").disabled = true;
...
Aislamiento_calc.addEventListener("change",function(){
...
BotonBuscar.addEventListener("click",function(){
  ...
  var TipoAislamiento = document.getElementById("Aislamiento_calc").value;
  var TempAmbiente = document.getElementById("Temperatura").value;
  ...
  if (FT == 0){
     ...
     document.getElementById("Alerta").innerHTML = "<strong> Para este rango de Temperatura y Tipo de Aislamiento no esta definido ningun factor de temperatura, pruebe con otros valores! </strong>";
       ...
       for (i=0;i<=25;i++) {   
         if (MCMlista == false){
           if ( AWG == Calibre[i] ){
             IZ = Math.round(1000*FA*FT*CorrienteTabla[i])/1000;
            var Calibre_Sel = AWG;
            console.log(Calibre_Sel);
            }        
         } else {
           if ( MCM == Calibre[i] ){
             IZ = Math.round(1000*FA*FT*CorrienteTabla[i])/1000;
   ...
   if (IZ == 0){
    document.getElementById("Resultado1").innerHTML = "<strong> Valor no definido<br> pruebe con otros valores! </strong>";   
    document.getElementById("Resultado2").innerHTML = "";
    document.getElementById("Resultado3").innerHTML = "";
    mostrarPopup();
  } else {
    document.getElementById("Resultado1" ).innerHTML = "<strong>Conductor " +TipoMaterial + "<br>Calibre "+ Calibre_Sel +" </strong>";
    document.getElementById("Resultado2").innerHTML = "<strong>"+ IZ +" Amp (máx) </strong>";
    document.getElementById("Resultado2").style.color = "blue";
    document.getElementById("Resultado3").innerHTML = "<strong>Tabla 310-16 NEC </strong>";
    document.getElementById("Resultado3").style.fontSize = "15px";
    mostrarPopup();
  } 

}); 
// Fin Capacidad Conductor 
...
// Fin Funciones Capacidad Conductor 
