...
window.addEventListener("load",function(){
  ...
  document.getElementById("Resultados_conversion"   ).hidden = true;
  document.getElementById("Potencia_conversion"   ).hidden = false;
...
// Conversion 
TipoUnidad_conversion.addEventListener("change",function(){

  var Unidad = document.getElementById("TipoUnidad_conversion");
  ...
  if (Tipo =="Energia"){
    document.getElementById("Potencia_conversion").hidden = true;
    document.getElementById("Temp").hidden = true;
    document.getElementById("Longitud"   ).hidden = true;
  }
...
if (Tipo =="Potencia"){
  ...
  document.getElementById("Resultados_conversion").hidden = false;
